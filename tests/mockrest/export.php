...
/**
 * Export of  INTUITEL Events (for debugging purpouses)
 *
...
function get_user_events($userid, $courseid, $fromtime, $totime, $limit_event_num = null) {
    $adaptor = intuitel\Intuitel::getAdaptorInstance();
    $courseLo = $adaptor->createLO(
            intuitel\Intuitel::getIDFactory()->getLoIdfromId('course', $courseid));
