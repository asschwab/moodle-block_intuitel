...
if ($ADMIN->fulltree) {
    ...
    $settings->add(new admin_setting_configtext('block_intuitel_LMS_Id', get_string('intuitel_intuitel_LMS_id', 'block_intuitel'),
    ...
    $settings->add(new admin_setting_configtext('block_intuitel_graphviz_command',
            ...
            'dot'));
    $settings->add(new admin_setting_configfile('block_intuitel_debug_file', get_string('intuitel_debug_file', 'block_intuitel'),
